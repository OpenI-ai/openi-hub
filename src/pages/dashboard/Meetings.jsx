            ...
            <div style={{ display: 'grid', gap: 14 }}>
              ...
              <div>
                ...
                <input value={form.title} onChange={e => setForm(f => ({ ...f, title: e.target.value }))}
                  ...
                  style={{ width: '100%', padding: '10px 12px', fontSize: 16, border: '1px solid #ddd', borderRadius: 10, boxSizing: 'border-box' }} />
              </div>
              ...
              <div>
                ...
                <textarea value={form.description} onChange={e => setForm(f => ({ ...f, description: e.target.value }))}
                  ...
                  rows={3}
                  style={{ width: '100%', padding: '10px 12px', fontSize: 16, border: '1px solid #ddd', borderRadius: 10, resize: 'vertical', boxSizing: 'border-box' }} />
              </div>
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input value={userSearch} onChange={e => handleUserSearch(e.target.value)}
                    ...
                    style={{ width: '100%', padding: '10px 12px 10px 32px', fontSize: 16, border: '1px solid #ddd', borderRadius: 10, boxSizing: 'border-box' }} />
