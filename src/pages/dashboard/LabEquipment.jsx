...
export default function LabEquipment() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1100, margin: '0 auto' }}>
      <div id="tour-page-lab-equipment-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, margin: 0 }}>Lab Equipment & Bookings</h1>
        {tab === 0 && (
          <button id="tour-page-lab-equipment-add" onClick={() => { setModal(true); setForm({}); }}
