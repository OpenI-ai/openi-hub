        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
          <div style={{ position: 'relative' }}>
            ...
            <input placeholder="Search startups…" value={search} onChange={e => setSearch(e.target.value)}
              style={{ paddingLeft: 28, paddingRight: 12, paddingTop: 8, paddingBottom: 8, background: '#fff', border: '1.5px solid #eee', borderRadius: 9, fontSize: 16, color: '#1a1a1a', width: 180 }}
            />
          </div>
          {/* View toggle */}
