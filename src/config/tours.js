...
const corporateSteps = [
  ...
  { target: '#tour-corp-pipeline',            title: 'Collaboration Pipeline',     content: 'Active collaborations across all stages — from outreach to signed POCs — visible right here.', placement: 'bottom' },
  ...
  { target: navTarget('collaborations'),      title: 'Track Collaborations',       content: 'POCs, paid pilots, pilots-to-production — manage every active collaboration with milestones and budget.', placement: 'right' },
...
const investorSteps = [
  ...
  { target: navTarget('find-startups'),      title: 'Find Startups',             content: 'Filter 14,000+ startups by stage, sector, traction (MRR/ARR), tech, geography. AI surfaces best fits to your thesis.', placement: 'right' },
  ...
  { target: navTarget('deeptech'),           title: 'DeepTech Index',            content: 'Browse startups scored against DeepTech criteria — TRL, IP, talent, capital intensity. Useful for thesis-fit.', placement: 'right' },
