/**
 * AuditLogsTab - extracted from Settings.jsx (Phase 166 / W5-3).
 * The body between the sentinels is a VERBATIM slice of the pre-split file,
 * original lines 1420-1445 of 1507. Nothing inside was reformatted or reindented.
...
export default function AuditLogsTab({ billingLoading, loadBilling, myPlan, setTab }) {
  // ---- BODY START (original lines 1420-1445) ----
