...
**Pending verification:** Invite-email persona framing (`2f5d11d`) — testing-team inbox checks, Path A + Path B per inviter role. Spot-check tours fire on the moved mount (`085cc07`). 401/idle banners in prod (`4f73c0b`). Phase 122 + 123 mobile dashboard layout on real device. Phase 120 mobile Back button.
