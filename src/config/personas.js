...
export const PERSONA_NAV = {
  ...
  corporate: [
    ...
    { to: '/dashboard/students',            label: 'Source Students', icon: 'GraduationCap' },
    { to: '/dashboard/academia',            label: 'Source Academia', icon: 'BookOpen' },
...
export const PROFILE_FIELDS = {
  ...
  investor: [
    ...
    { name: 'ticket_size_min', label: 'Ticket Size Min',  type: 'number' },
    { name: 'ticket_size_max', label: 'Ticket Size Max',  type: 'number' },
    { name: 'ticket_size_currency', label: 'Ticket Currency', type: 'select', options: ['INR','USD'] },
