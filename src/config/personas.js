...
export const PROFILE_FIELDS = {
  startup: [
    ...
    { name: 'mrr',            label: 'MRR (Monthly Recurring Revenue)', type: 'money_range', variant: 'revenue' },
    { name: 'arr',            label: 'ARR (Annual Recurring Revenue)', type: 'money_range', variant: 'revenue' },
    ...
    // ── Financials ────────────────────────────────────
    { name: 'funding_raised', label: 'Total Funding Raised', type: 'money_range', variant: 'revenue' },
    ...
    { name: 'last_funding_amount', label: 'Last Funding Amount', type: 'money_range', variant: 'revenue' },
    ...
    { name: 'burn_rate',      label: 'Monthly Burn Rate',    type: 'money_range', variant: 'revenue' },
  ...
  investor: [
    ...
    { name: 'fund_size',       label: 'Fund Size',             type: 'money_range', variant: 'revenue' },
    { name: 'total_aum',       label: 'Total AUM',             type: 'money_range', variant: 'revenue' },
    { name: 'available_to_deploy', label: 'Available to Deploy', type: 'money_range', variant: 'revenue' },
    ...
    { name: 'ticket_size_range', label: 'Ticket Size',          type: 'money_range', variant: 'ticket' },
